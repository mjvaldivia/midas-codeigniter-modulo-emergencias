...
<div class="row">
    <?php if (1): ?>
        <div class="col-xs-12 text-right">
            <a href="<?php echo base_url('vectores/excel') ?>" class="btn btn-primary btn-square" target="_blank"><i
                    class="fa fa-file-excel-o"></i> Descargar Excel</a>
            <?php if (!$presidencia): ?>
                <a href="<?php echo base_url('vectores/denuncias') ?>" class="btn btn-success btn-square"><i
                        class="fa fa-plus"></i> Nueva Denuncia</a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
