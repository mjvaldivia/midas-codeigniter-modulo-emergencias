        ...
        <div id="pResultados" class="portlet portlet-default">
            <div class="portlet-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <legend>Revisión de la denuncia
                                        ...
                                        <div class="row">
                                            <?php foreach ($imagenes as $imagen): ?>
                                                <div class="col-xs-6 col-md-3" style="padding:5px;border:1px solid #111;">
                                                    <img src="<?php echo base_url($imagen['ruta'].'/'.$imagen['nombre']) ?>" class="img-responsive" style="height: 150px;cursor:pointer;"
                        ...
                        <div class="col-xs-12 col-md-6">
                                    ...
                                    <?php if ($id > 0): ?>
                                        <div class="portlet portlet-dark-blue" style="margin-top:25px">
                                            <div class="portlet-heading text-center">
                                                ...
                                                <span style="font-size:96px">D-<?php echo $id ?></span>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <textarea class="form-control" rows="5" id="comentarios_ciudadano" name="comentarios_ciudadano" disabled><?php echo $comentarios_ciudadano?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-12">
                                        <textarea class="form-control" rows="5" name="observaciones_resultado" id="observaciones_resultado"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                <?php if ($id > 0): ?>
                                    <button type="button" class="btn btn-success btn-square"
                                            onclick="Vectores.guardarResultado(this.form,this);">
                                        <i class="fa fa-send"></i> Guardar
                                    </button>

                                <?php else: ?>
                                    <button type="button" class="btn btn-success btn-square"
                                            onclick="Vectores.guardar(this.form,this);">
