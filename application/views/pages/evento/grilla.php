        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="10%" class="text-center">
                    ...
                    <?php if (permisoEvento("reporte") and $row['est_ia_id'] > 1) { ?>
                    ...
                    <?php if (permisoEvento("eliminar") and $row['est_ia_id'] < 2) { ?>
