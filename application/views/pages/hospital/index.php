        ...
        <div class="page-title">
            <h1>  Hospitales
                <div class="pull-right">
                    ...
                    <a href="<?php echo base_url("hospital/nuevo"); ?>" id="nueva" class="btn btn-square btn-green">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-bell"></i> Hospitales </li>
            </ol>
        </div>
    </div>
</div>
