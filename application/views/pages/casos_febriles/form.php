<div class="row">
    <div class="col-lg-12">
        <div class="page-title">
            <h1> Gestión de vigilancia de casos febriles/exantemáticos </h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i><a href="#"> Inicio </a></li>
                <li><i class="fa fa-list"></i> <a href="<?php echo base_url(getController() . "/index") ?>"> Casos febriles</a></li>
                <li class="active"><i class="fa fa-bell"></i> Formulario </li>
                
                <?php if(permisoCasosFebriles("editar") || permisoCasosFebriles("eliminar") || permisoCasosFebriles("reporte")){ ?>
                <li class="pull-right"><a href="<?php echo base_url(getController() . "/index") ?>"> <i class="fa fa-backward"></i> Volver </a></li>
                <?php } ?>
            </ol>
        </div>
    </div>
...
<div class="row">
    <div class="col-xs-12">
        <div class="row">
            ...
            <form id="form-dengue" autocomplete="off" class="form-vertical" action="<?php echo base_url(getController() . "/guardar") ?>" method="post" role="form">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet portlet-default">
                    <div class="portlet-body">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="<?php if(!permisoCasosFebriles("datos_personales")) echo "hidden"; ?>">
                                <div class="col-xs-5">
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="hospitalizacion" name="hospitalizacion" type="checkbox" <?= formCheckboxValue("Si", $hospitalizacion); ?>> Hospitalización
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="fallecido" name="fallecido" type="checkbox" <?= formCheckboxValue("Si", $fallecido); ?>> Fallecido
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="fiebre" name="fiebre" type="checkbox" <?= formCheckboxValue("Si", $fiebre); ?>> Fiebre
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="exantema_generalizado" name="exantema_generalizado" type="checkbox" <?= formCheckboxValue("Si", $exantema_generalizado); ?>> Exantema generalizado
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="calofrios" name="calofrios" type="checkbox" <?= formCheckboxValue("Si", $calofrios); ?>> Calofríos
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="sudoracion" name="sudoracion" type="checkbox" <?= formCheckboxValue("Si", $sudoracion); ?>> Sudoración
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="cefalea_dolor_retroorbitario" name="cefalea_dolor_retroorbitario" type="checkbox" <?= formCheckboxValue("Si", $cefalea_dolor_retroorbitario); ?>> Cefalea / Dolor retroorbitario
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            <input id="tos" name="tos" type="checkbox" <?= formCheckboxValue("Si", $tos); ?>> Tos
                            ...
                            <div class="col-xs-3">
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            <input id="coriza" name="coriza" type="checkbox" <?= formCheckboxValue("Si", $coriza); ?>> Coriza
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="mialgia" name="mialgia" type="checkbox" <?= formCheckboxValue("Si", $mialgia); ?>> Mialgia 
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="artralgia" name="artralgia" type="checkbox" <?= formCheckboxValue("Si", $artralgia); ?>> Artralgia
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="conjuntivitis" name="conjuntivitis" type="checkbox" <?= formCheckboxValue("Si", $conjuntivitis); ?>> Conjuntivitis
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="nauseas_vomito" name="nauseas_vomito" type="checkbox" <?= formCheckboxValue("Si", $nauseas_vomito); ?>> Náuseas / Vómito
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="diarrea" name="diarrea" type="checkbox" <?= formCheckboxValue("Si", $diarrea); ?>> Diarrea
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="edema_de_articulacion_manos_y_pies" name="edema_de_articulacion_manos_y_pies" type="checkbox" <?= formCheckboxValue("Si", $edema_de_articulacion_manos_y_pies); ?>>  Edema de articulación de manos/pies
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="ictericia" name="ictericia" type="checkbox" <?= formCheckboxValue("Si", $ictericia); ?>> Ictericia
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="torniquete" name="torniquete" type="checkbox" <?= formCheckboxValue("Si", $torniquete); ?>> Torniquete (+)
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="leucopenia" name="leucopenia" type="checkbox" <?= formCheckboxValue("Si", $leucopenia); ?>> Leucopenia
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="acumulacion_extravascular_de_fluidos" name="acumulacion_extravascular_de_fluidos" type="checkbox" <?= formCheckboxValue("Si", $acumulacion_extravascular_de_fluidos); ?>> Acumulación extravascular de fluidos
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="dolor_o_sensibilidad_abdominal" name="dolor_o_sensibilidad_abdominal" type="checkbox" <?= formCheckboxValue("Si", $dolor_o_sensibilidad_abdominal); ?>> Dolor/sensibilidad abdominal
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="sangramiento_de_mucosas" name="sangramiento_de_mucosas" type="checkbox" <?= formCheckboxValue("Si", $sangramiento_de_mucosas); ?>> Sangramiento de mucosas
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="hepatomegalia_2cm" name="hepatomegalia_2cm" type="checkbox" <?= formCheckboxValue("Si", $hepatomegalia_2cm); ?>> Hepatomegalia > 2cm
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="aumento_hematocrito" name="aumento_hematocrito" type="checkbox" <?= formCheckboxValue("Si", $aumento_hematocrito); ?>> Aumento hematocrito
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="disminucion_de_plaquetas" name="disminucion_de_plaquetas" type="checkbox" <?= formCheckboxValue("Si", $disminucion_de_plaquetas); ?>> Disminución de plaquetas
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="sdra" name="sdra" type="checkbox" <?= formCheckboxValue("Si", $sdra); ?>> SDRA
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="shock" name="shock" type="checkbox" <?= formCheckboxValue("Si", $shock); ?>> Shock
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="sangramiento_severo" name="sangramiento_severo" type="checkbox" <?= formCheckboxValue("Si", $sangramiento_severo); ?>> Sangramiento severo
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="compromiso_severo_de_organos" name="compromiso_severo_de_organos" type="checkbox" <?= formCheckboxValue("Si", $compromiso_severo_de_organos); ?>> Compromiso severo de órganos
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="meningitis_encefalitis" name="meningitis_encefalitis" type="checkbox" <?= formCheckboxValue("Si", $meningitis_encefalitis); ?>> Meningitis/encefalitis
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="paralisis_flaccida_aguda" name="paralisis_flaccida_aguda" type="checkbox" <?= formCheckboxValue("Si", $paralisis_flaccida_aguda); ?>> Parálisis fláccida aguda/Sind. Guillain-Barré
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="vertigo" name="vertigo" type="checkbox" <?= formCheckboxValue("Si", $vertigo); ?>> Vértigo
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="paresia" name="paresia" type="checkbox" <?= formCheckboxValue("Si", $paresia); ?>> Paresia
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="rigidez_de_nuca" name="rigidez_de_nuca" type="checkbox" <?= formCheckboxValue("Si", $rigidez_de_nuca); ?>> Rigidez de nuca
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="albuminuria" name="albuminuria" type="checkbox" <?= formCheckboxValue("Si", $albuminuria); ?>> Albuminuria
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="anemia_severa" name="anemia_severa" type="checkbox" <?= formCheckboxValue("Si", $anemia_severa); ?>> Anemia severa
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="dificultad_respiratoria" name="dificultad_respiratoria" type="checkbox" <?= formCheckboxValue("Si", $dificultad_respiratoria); ?>> Dificultad respiratoria
                                        </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="portlet portlet-default">
                    <div class="portlet-body" style="overflow: visible;">
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_pcr_sangre" name="muestra_pcr_sangre" type="checkbox" <?= formCheckboxValue("Si", $muestra_pcr_sangre); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_pcr_orina" name="muestra_pcr_orina" type="checkbox" <?= formCheckboxValue("Si", $muestra_pcr_orina); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_pcr_lce" name="muestra_pcr_lce" type="checkbox" <?= formCheckboxValue("Si", $muestra_pcr_lce); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_pcr_rechaza_toma" name="muestra_pcr_rechaza_toma" type="checkbox" <?= formCheckboxValue("Si", $muestra_pcr_rechaza_toma); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_serologia_sangre" name="muestra_serologia_sangre" type="checkbox" <?= formCheckboxValue("Si", $muestra_serologia_sangre); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_serologia_orina" name="muestra_serologia_orina" type="checkbox" <?= formCheckboxValue("Si", $muestra_serologia_orina); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_serologia_lce" name="muestra_serologia_lce" type="checkbox" <?= formCheckboxValue("Si", $muestra_serologia_lce); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_serologia_rechaza_toma" name="muestra_serologia_rechaza_toma" type="checkbox" <?= formCheckboxValue("Si", $muestra_serologia_rechaza_toma); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_frotis_sangre" name="muestra_frotis_sangre" type="checkbox" <?= formCheckboxValue("Si", $muestra_frotis_sangre); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_frotis_orina" name="muestra_frotis_orina" type="checkbox" <?= formCheckboxValue("Si", $muestra_frotis_orina); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_frotis_lce" name="muestra_frotis_lce" type="checkbox" <?= formCheckboxValue("Si", $muestra_frotis_lce); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_frotis_rechaza_toma" name="muestra_frotis_rechaza_toma" type="checkbox" <?= formCheckboxValue("Si", $muestra_frotis_rechaza_toma); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_otro_sangre" name="muestra_otro_sangre" type="checkbox" <?= formCheckboxValue("Si", $muestra_otro_sangre); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_otro_orina" name="muestra_otro_orina" type="checkbox" <?= formCheckboxValue("Si", $muestra_otro_orina); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_otro_lce" name="muestra_otro_lce" type="checkbox" <?= formCheckboxValue("Si", $muestra_otro_lce); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                            ...
                                            <td align="center">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input id="muestra_otro_rechaza_toma" name="muestra_otro_rechaza_toma" type="checkbox" <?= formCheckboxValue("Si", $muestra_otro_rechaza_toma); ?>>
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <td width="15%">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="se_solicita_analisis_para_dengue" name="se_solicita_analisis_para_dengue" type="checkbox" <?= formCheckboxValue("Si", $se_solicita_analisis_para_dengue); ?>> Dengue
                                                </label>
                                            </div>
                                        </td>
                                        <td width="15%">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="se_solicita_analisis_para_chikungunya" name="se_solicita_analisis_para_chikungunya" type="checkbox" <?= formCheckboxValue("Si", $se_solicita_analisis_para_chikungunya); ?>> Chikungunya
                                                </label>
                                            </div>
                                        </td>
                                        <td width="15%">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="se_solicita_analisis_para_zika" name="se_solicita_analisis_para_zika" type="checkbox" <?= formCheckboxValue("Si", $se_solicita_analisis_para_zika); ?>> Zika
                                                </label>
                                            </div>
                                        </td>
                                        <td width="15%">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="se_solicita_analisis_para_fiebre_amarilla" name="se_solicita_analisis_para_fiebre_amarilla" type="checkbox" <?= formCheckboxValue("Si", $se_solicita_analisis_para_fiebre_amarilla); ?>> Fiebre Amarilla
                                                </label>
                                            </div>
                                        </td>
                                        <td width="15%">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="se_solicita_analisis_para_virus_del_nilo_occidental" name="se_solicita_analisis_para_virus_del_nilo_occidental" type="checkbox" <?= formCheckboxValue("Si", $se_solicita_analisis_para_virus_del_nilo_occidental); ?>> Virus del Nilo Occidental
                                                </label>
                                            </div>
                                        </td>
                                        <td width="15%">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input id="se_solicita_analisis_para_fiebre_malaria" name="se_solicita_analisis_para_malaria" type="checkbox" <?= formCheckboxValue("Si", $se_solicita_analisis_para_malaria); ?>> Malaria
                                                </label>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="row top-spaced">
                            ...
                            <div class="col-xs-3">
                                 <div class="tile blue <?php if(!permisoCasosFebriles("conclusiones")) echo "hidden"; ?>" style="overflow: visible">
                                    <div class="form-group clearfix">
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="viaje_fuera_de_isla_de_pascua" name="viaje_fuera_de_isla_de_pascua" type="checkbox" <?= formCheckboxValue("Si", $viaje_fuera_de_isla_de_pascua); ?>> Viaje fuera de Isla de Pascua
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="viaje_reciente_al_extranjero" name="viaje_reciente_al_extranjero" type="checkbox" <?= formCheckboxValue("Si", $viaje_reciente_al_extrangero); ?>> Viaje reciente al extranjero
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="antecedentes_de_dengue_previo" name="antecedentes_de_dengue_previo" type="checkbox" <?= formCheckboxValue("Si", $antecedentes_de_dengue_previo); ?>> Antecedentes de dengue previo
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="caso_febril_grupo_familiar" name="caso_febril_grupo_familiar" type="checkbox" <?= formCheckboxValue("Si", $caso_febril_grupo_familiar); ?>> Caso febril actual en el grupo familiar
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input id="vacunacion_contra_fiebre_amarilla" name="vacunacion_contra_fiebre_amarilla" type="checkbox" <?= formCheckboxValue("Si", $vacunacion_contra_fiebre_amarilla); ?>> Vacunación contra fiebre amarilla
                                        </label>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row top-spaced">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <?php if(!permisoCasosFebriles("conclusiones")) { ?>
                        <button id="enviar" class="btn btn-blue" type="button"><i class="fa fa-send"></i> Guardar y enviar a delegado de epidemiología</button>
                        <?php } ?>
                        <button class="btn btn-white" type="reset" onClick="document.location.href='<?php echo base_url(getController() . "/index") ?>'"><i class="fa fa-ban"></i> Cancelar</button>
                    </div>
                </div>
                </div>
            </div>
