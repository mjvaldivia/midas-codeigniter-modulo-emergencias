                ...
                <div class="portlet-body"> 
                    ...
                    <div class="row">
                        ...
                        <?php // if(puedeVerGraficos):?>
                            <a href="<?php echo base_url(getController() . "/grafico"); ?>"  class="btn btn-orange btn-square">
                            <i class="fa fa-bar-chart"></i>
                            Reporte Gráfico
                        </a>
                        <?php // endif;?>
                        <?php // if(puedeVerReporteEmergencia("casos_febriles")) { ?>
                        <a href="<?php echo base_url(getController() . "/excel"); ?>" target="_blank" id="descargar" class="btn btn-default btn-square">
                        ...
                        <a href="<?php echo base_url(getController() . "/nuevo"); ?>" id="nueva" class="btn btn-square btn-green">
