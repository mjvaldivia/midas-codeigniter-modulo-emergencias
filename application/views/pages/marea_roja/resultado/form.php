                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group clearfix">
                                        ...
                                        <input value="<?php if(empty($propiedades["resultado_fecha"])) echo date('d/m/Y'); else echo $propiedades["resultado_fecha"]; ?>" class="form-control datepicker-date" name="resultado_fecha" id="resultado_fecha">
                                        <span class="help-block hidden"></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3">
                        <div class="form-group clearfix">
                            ...
                            <input value="<?php echo $propiedades["temperatura_agua"]; ?>" disabled class="form-control" name="temperatura_agua" id="temperatura_agua">
                            <span class="help-block hidden"></span>
                        </div>
                    </div>
                    <div class="col-xs-3">
