 ...
 */
Class Formulario_Form_Element_SelectEnfermedades{
    ...
    public function __construct() {
        ...
        $this->ci->load->model("enfermedad_model");
        $this->enfermedad_model = $this->ci->enfermedad_model;
    }
    ...
    protected function _listar(){
        return $this->enfermedad_model->listarTodos();
    }
}
