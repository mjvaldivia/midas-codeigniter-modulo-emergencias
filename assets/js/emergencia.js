    ...
    this.eventoBtnBuscar = function () {
        ...
        $.get(url).done(function (retorno) {
            ...
            json.columns[0]["mRender"] = function (data, type, row) {
                ...
                html += "     <a data-toggle='modal' class='btn btn-default modal-sipresa' data-style='width:80%;' data-href='"+ siteUrl +"visor/reporte/id/"+row.eme_ia_id+"' data-title='Administracion del Reporte' data-success='exportarMapa("+row.eme_ia_id+");' data-target='#modal_recal_"+row.eme_ia_id+"'><i class='fa fa-fa2x fa-file-text-o'></i></a>";
